use crate::{
    ...
    models::{
        ...
        Auth, AuthGuard, Board, Company, NewAuth, NewCompany, NewProject, NewUser, Project, User,
    },
};
use async_graphql::{guard::Guard, Context, Error, Object, Result as GQLResult};
...
impl MutationRoot {
    ...
    #[graphql(guard(AuthGuard(is_auth = "true")))]
